          ...
          if (res.status === 200) {
            ...
            if (newArchiveData.distance === 100) {
              ...
              saveLog({
                ...
                data: "NAUTILUS navigator",
                decision_variables:
                  bodyFinal.response.decision_vectors.join(","),
                objective_values:
                  bodyFinal.response.objective_vectors.join(","),
              });
              SetShowFinal(true);
                  ...
                  <Row className="bottom-div">
                    <Col sm={6} className="p-3">
                      <Button
                        ...
                        variant="primary"
                      >
                        <MdPlayCircle size="lg" />
                      </Button>
                    </Col>
                    <Col sm={6} className="p-3">
                      {showFinal && <>Export solution(s) to CSV</>}
                      {!showFinal && (
                        <Button
                          size="lg"
                          onClick={toggleIteration}
